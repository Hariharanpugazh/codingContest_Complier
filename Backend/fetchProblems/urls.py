...
urlpatterns = [
    ...
    path('updateQuestionById/', views.update_question_by_id, name='update_question_by_id'),
    path('deleteQuestionById/', views.delete_question_by_id, name='delete_question_by_id'),
]
